        ...
        <div class="col-sm-6 col-sm-offset-3">
            <div class="panel panel-primary">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title pull-left">Editar calificación al becario: {!! $student->itesm_id !!}</h3>
                ...
                <div class="modal-body">
                    ...
                    {!! Form::model($student->rate,['method' => 'PUT','action' => ['RateSchoolBoyController@updateRate',$student->id],'class'=>'form-horizontal']) !!}
                    ...
                    {!! Form::submit('Actualizar califcación',['class' => 'btn btn-primary  btn-block form-control']) !!}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
