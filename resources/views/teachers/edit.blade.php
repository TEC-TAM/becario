        ...
        <div class="col-sm-6 col-sm-offset-3">
            <div class="panel panel-primary">
                <div class="panel-heading clearfix">
                    <h3 class="panel-title pull-left">Editar información de: {!! $teacher->itesm_id !!}</h3>
                    <div class="btn-group pull-right">
                        {!! HTML::decode(link_to('teachers/'.$teacher->id,'<i class="glyphicon glyphicon-arrow-left"></i> Volver',['class' => 'btn btn-xs btn-default'],null )) !!}
                    </div>
                </div>
                <div class="modal-body">
                    @include('partials.errors')
                    {!! Form::model($teacher,['method' => 'PUT','action' => ['TeachersController@update',$teacher->id],'class'=>'form-horizontal']) !!}
                    {!! Form::hidden('type',0) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            {!! Form::input('password','password',null,['class' => 'form-control','placeholder' => 'Nomina']) !!}
                        </div>
                    </div>
                    <div class="form-group">
